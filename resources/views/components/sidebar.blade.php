<aside id="crmt-nav-sidebar" class="w-96 bg-[#0F172A] text-white flex flex-col flex-shrink-0 transition-all duration-300 fixed left-0 top-0 h-full z-10 shadow-xl">
    ...
    <nav class="flex-1 overflow-y-auto py-4">
        @php
            $m1_active = request()->routeIs('reports.1.*');
            $m2_active = request()->routeIs('reports.2.*');
            $m3_active = request()->routeIs('reports.3.*');
            $m4_active = request()->routeIs('reports.4.*');
            $m5_active = request()->routeIs('reports.5.*');
            $m6_active = request()->routeIs('reports.6.*');
            $m7_active = request()->routeIs('reports.7.*');
        @endphp
        ...
        <div class="nav-group">
            <a href="#" onclick="toggleCRMTSubmenu(this); return false;" class="nav-item flex items-center justify-between gap-3 px-4 py-3 text-gray-400 hover:text-white hover:bg-gray-800 transition-colors cursor-pointer">
                <div class="flex items-center gap-3">
                    <i class="fa-solid fa-chart-line w-5 text-center {{ $m1_active ? 'text-white' : '' }}"></i>
                    <span class="nav-text text-sm font-medium {{ $m1_active ? 'text-white' : '' }}">M.1 Marketer's Must-Haves</span>
                </div>
        ...
        <div class="nav-group">
            <a href="#" onclick="toggleCRMTSubmenu(this); return false;" class="nav-item flex items-center justify-between gap-3 px-4 py-3 text-gray-400 hover:text-white hover:bg-gray-800 transition-colors cursor-pointer">
                <div class="flex items-center gap-3">
                    <i class="fa-solid fa-file-lines w-5 text-center {{ $m2_active ? 'text-white' : '' }}"></i>
                    <span class="nav-text text-sm font-medium {{ $m2_active ? 'text-white' : '' }}">M.2 Content & Creator</span>
                </div>
        ...
        <div class="nav-group">
            <a href="#" onclick="toggleCRMTSubmenu(this); return false;" class="nav-item flex items-center justify-between gap-3 px-4 py-3 text-gray-400 hover:text-white hover:bg-gray-800 transition-colors cursor-pointer">
                <div class="flex items-center gap-3">
                    <i class="fa-solid fa-shield w-5 text-center {{ $m3_active ? 'text-white' : '' }}"></i>
                    <span class="nav-text text-sm font-medium {{ $m3_active ? 'text-white' : '' }}">M.3 Compliance & Social</span>
                </div>
        ...
        <div class="nav-group">
            <a href="#" onclick="toggleCRMTSubmenu(this); return false;" class="nav-item flex items-center justify-between gap-3 px-4 py-3 text-gray-400 hover:text-white hover:bg-gray-800 transition-colors cursor-pointer">
                <div class="flex items-center gap-3">
                    <i class="fa-solid fa-gavel w-5 text-center {{ $m4_active ? 'text-white' : '' }}"></i>
                    <span class="nav-text text-sm font-medium {{ $m4_active ? 'text-white' : '' }}">M.4 Regulatory & Legal</span>
                </div>
        ...
        <div class="nav-group">
            <a href="#" onclick="toggleCRMTSubmenu(this); return false;" class="nav-item flex items-center justify-between gap-3 px-4 py-3 text-gray-400 hover:text-white hover:bg-gray-800 transition-colors cursor-pointer">
                <div class="flex items-center gap-3">
                    <i class="fa-solid fa-briefcase w-5 text-center {{ $m5_active ? 'text-white' : '' }}"></i>
                    <span class="nav-text text-sm font-medium {{ $m5_active ? 'text-white' : '' }}">M.5 M&A Better Deals</span>
                </div>
        ...
        <div class="nav-group">
            <a href="#" onclick="toggleCRMTSubmenu(this); return false;" class="nav-item flex items-center justify-between gap-3 px-4 py-3 text-gray-400 hover:text-white hover:bg-gray-800 transition-colors cursor-pointer">
                <div class="flex items-center gap-3">
                    <i class="fa-solid fa-handshake w-5 text-center {{ $m6_active ? 'text-white' : '' }}"></i>
                    <span class="nav-text text-sm font-medium {{ $m6_active ? 'text-white' : '' }}">M.6 Consulting Augment</span>
                </div>
        ...
        <div class="nav-group">
            <a href="#" onclick="toggleCRMTSubmenu(this); return false;" class="nav-item flex items-center justify-between gap-3 px-4 py-3 text-gray-400 hover:text-white hover:bg-gray-800 transition-colors cursor-pointer">
                <div class="flex items-center gap-3">
                    <i class="fa-solid fa-building w-5 text-center {{ $m7_active ? 'text-white' : '' }}"></i>
                    <span class="nav-text text-sm font-medium {{ $m7_active ? 'text-white' : '' }}">M.7 Brand Intelligence</span>
                </div>
